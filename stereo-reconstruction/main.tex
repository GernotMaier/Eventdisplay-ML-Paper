...
IACTs measure Cherenkov light generated by extensive air showers while propagating
through the atmosphere.
The image of the air shower in the camera is a projection of the longitudinal development
and contains information on the primary particle's energy and direction.
Each method described below provides estimates with different accuracy and systematic biases
depending on the energy of the primary particle, shower geometry, image quality, and observation conditions.
The results, intermediate quantities, image parameters, and array geometry are used as input
features for the machine-learning regression model with the goal of improving the baseline reconstruction.
